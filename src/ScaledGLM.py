...
#---Paths---
hbRoot = "processed_hb"
outDir = "Personal output folder for results"
agePath = "TC_ALL_DOB.xlsx" #Date of Birth Data
behavPath = "TC_Behavioral_Data.xlsx" #Behavioral Data
...
print(hboConditionModel.fit(method="lbfgs").summary())
...
print(hboAgeModel.fit(method="lbfgs").summary())
...
print(hboAccuracyModel.fit(method="lbfgs").summary())
